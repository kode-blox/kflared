...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kflared-builder
	$(CONTAINER_TOOL) buildx use kflared-builder
	...
	- $(CONTAINER_TOOL) buildx rm kflared-builder
	rm Dockerfile.cross
