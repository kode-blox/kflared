...
// +kubebuilder:rbac:groups=kflared.kodeblox.com,resources=cloudflaretunnelbindings,verbs=get;list;watch;create;update;patch;delete
...
// the CloudflareTunnelBinding object against the actual cluster state, and then
