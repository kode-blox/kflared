...
var _ = BeforeSuite(func() {
	...
	var err error
	err = kflaredv1alpha1.AddToScheme(scheme.Scheme)
...
// Taskfile tasks, the 'BinaryAssetsDirectory' must be explicitly configured.
//
// This function streamlines the process by finding the required binaries, similar to
// setting the 'KUBEBUILDER_ASSETS' environment variable. To ensure the binaries are
// properly set up, run 'go -C tools/task tool task --dir ../.. setup-envtest' beforehand.
